...
class Heap {
    ...
    public:
        ...
        "Bubble up" the new element by comparing it with its parent and swapping if necessary.
        */
        void insert(T element) {
            //add at the end of the vector
            tree.push_back(element);

            // Get index of the newly element added
            ...
            while (index > 1) {
                ...
                if (this->tree.at(parentIndex) > this->tree.at(index)) {
                    ...
                    //update the index to compare with its parent to make sure properties align
                    index = parentIndex;
                } else {
                    break;
                }
        ...
        void remove(T value) {
            ...
            //find the index of the value need to be removed
            ...
            std::swap(this->tree.at(lastIndex), this->tree.at(indexBeRemoved));
